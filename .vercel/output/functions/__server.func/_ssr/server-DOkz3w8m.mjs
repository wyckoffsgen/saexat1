...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DGjmUfXC.mjs");
...
const manifest = {
  "114603339148d6b7cfbc2a9a16d7c155014b773beb6587879438626e7354f351": {
    ...
    importer: () => import("./hotel-state.functions-Bp7cOSPa.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CQhdkXg6.mjs").then((n) => n.r),
    import("./start-Beh5pvCA.mjs"),
